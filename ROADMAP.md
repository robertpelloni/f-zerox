...
| **Netplay** | Lobby/Settings UI | **Implemented** | UDP Broadcast logic active with history ring-buffer, rollback style interpolation, and full 360 degree vector syncing. |
